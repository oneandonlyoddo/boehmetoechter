...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Wein.bouquet'
        db.alter_column(u'webshop_wein', 'bouquet', self.gf('django.db.models.fields.CharField')(max_length=2000, null=True))

    def backwards(self, orm):

        # Changing field 'Wein.bouquet'
        db.alter_column(u'webshop_wein', 'bouquet', self.gf('django.db.models.fields.CharField')(default=0, max_length=2000))
