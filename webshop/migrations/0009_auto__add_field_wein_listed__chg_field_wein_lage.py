...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Wein.listed'
        db.add_column(u'webshop_wein', 'listed',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


        # Changing field 'Wein.lage'
        db.alter_column(u'webshop_wein', 'lage', self.gf('django.db.models.fields.CharField')(max_length=2, null=True))

    def backwards(self, orm):
        # Deleting field 'Wein.listed'
        db.delete_column(u'webshop_wein', 'listed')


        # Changing field 'Wein.lage'
        db.alter_column(u'webshop_wein', 'lage', self.gf('django.db.models.fields.CharField')(default=0, max_length=2))
