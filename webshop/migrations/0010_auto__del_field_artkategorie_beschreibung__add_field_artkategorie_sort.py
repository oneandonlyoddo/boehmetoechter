...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ArtKategorie.beschreibung'
        db.delete_column(u'webshop_artkategorie', 'beschreibung')

        # Adding field 'ArtKategorie.sortID'
        db.add_column(u'webshop_artkategorie', 'sortID',
                      self.gf('django.db.models.fields.IntegerField')(default=1, max_length=1),
                      keep_default=False)

        # Adding field 'LageKategorie.sortID'
        db.add_column(u'webshop_lagekategorie', 'sortID',
                      self.gf('django.db.models.fields.IntegerField')(default=1, max_length=1),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ArtKategorie.beschreibung'
        db.add_column(u'webshop_artkategorie', 'beschreibung',
                      self.gf('django.db.models.fields.CharField')(max_length=2000, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'ArtKategorie.sortID'
        db.delete_column(u'webshop_artkategorie', 'sortID')

        # Deleting field 'LageKategorie.sortID'
        db.delete_column(u'webshop_lagekategorie', 'sortID')
