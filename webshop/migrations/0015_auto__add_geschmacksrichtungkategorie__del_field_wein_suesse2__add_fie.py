...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GeschmacksrichtungKategorie'
        db.create_table(u'webshop_geschmacksrichtungkategorie', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'webshop', ['GeschmacksrichtungKategorie'])

        # Deleting field 'Wein.suesse2'
        db.delete_column(u'webshop_wein', 'suesse2')

        # Adding field 'Wein.apnr'
        db.add_column(u'webshop_wein', 'apnr',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Wein.sulfite'
        db.add_column(u'webshop_wein', 'sulfite',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Wein.geschmack'
        db.add_column(u'webshop_wein', 'geschmack',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['webshop.GeschmacksrichtungKategorie'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'GeschmacksrichtungKategorie'
        db.delete_table(u'webshop_geschmacksrichtungkategorie')

        # Adding field 'Wein.suesse2'
        db.add_column(u'webshop_wein', 'suesse2',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Wein.apnr'
        db.delete_column(u'webshop_wein', 'apnr')

        # Deleting field 'Wein.sulfite'
        db.delete_column(u'webshop_wein', 'sulfite')

        # Deleting field 'Wein.geschmack'
        db.delete_column(u'webshop_wein', 'geschmack_id')
    ...
    models = {
        ...
        u'webshop.geschmacksrichtungkategorie': {
            'Meta': {'object_name': 'GeschmacksrichtungKategorie'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
        ...
        u'webshop.myorder': {
            ...
            'billFax': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            ...
            'billTel': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
        ...
        u'webshop.wein': {
            ...
            'apnr': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            ...
            'bouquet': ('django.db.models.fields.CharField', [], {'max_length': '2000', 'null': 'True', 'blank': 'True'}),
            'date_added': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'geschmack': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['webshop.GeschmacksrichtungKategorie']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'sulfite': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
