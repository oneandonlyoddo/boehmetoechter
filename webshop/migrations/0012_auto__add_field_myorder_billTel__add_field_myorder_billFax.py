...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'myOrder.billTel'
        db.add_column(u'webshop_myorder', 'billTel',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=255),
                      keep_default=False)

        # Adding field 'myOrder.billFax'
        db.add_column(u'webshop_myorder', 'billFax',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'myOrder.billTel'
        db.delete_column(u'webshop_myorder', 'billTel')

        # Deleting field 'myOrder.billFax'
        db.delete_column(u'webshop_myorder', 'billFax')
