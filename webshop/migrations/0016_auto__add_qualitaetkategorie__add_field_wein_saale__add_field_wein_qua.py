...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'QualitaetKategorie'
        db.create_table(u'webshop_qualitaetkategorie', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'webshop', ['QualitaetKategorie'])

        # Adding field 'Wein.saale'
        db.add_column(u'webshop_wein', 'saale',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Wein.qualitaet'
        db.add_column(u'webshop_wein', 'qualitaet',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['webshop.QualitaetKategorie'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'QualitaetKategorie'
        db.delete_table(u'webshop_qualitaetkategorie')

        # Deleting field 'Wein.saale'
        db.delete_column(u'webshop_wein', 'saale')

        # Deleting field 'Wein.qualitaet'
        db.delete_column(u'webshop_wein', 'qualitaet_id')
    ...
    models = {
        ...
        u'webshop.qualitaetkategorie': {
            'Meta': {'object_name': 'QualitaetKategorie'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
        u'webshop.wein': {
            ...
            'qualitaet': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['webshop.QualitaetKategorie']", 'null': 'True', 'blank': 'True'}),
            'saale': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
