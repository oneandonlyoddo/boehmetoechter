...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LageKategorie.beschreibung'
        db.alter_column(u'webshop_lagekategorie', 'beschreibung', self.gf('django.db.models.fields.CharField')(max_length=2000, null=True))

    def backwards(self, orm):

        # Changing field 'LageKategorie.beschreibung'
        db.alter_column(u'webshop_lagekategorie', 'beschreibung', self.gf('django.db.models.fields.CharField')(default=0, max_length=2000))
