...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ArtKategorie'
        db.create_table(u'webshop_artkategorie', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'webshop', ['ArtKategorie'])

        # Adding model 'LageKategorie'
        db.create_table(u'webshop_lagekategorie', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('beschreibung', self.gf('django.db.models.fields.CharField')(max_length=2000)),
        ))
        db.send_create_signal(u'webshop', ['LageKategorie'])

        # Deleting field 'Wein.main_category'
        db.delete_column(u'webshop_wein', 'main_category_id')

        # Adding field 'Wein.kat'
        db.add_column(u'webshop_wein', 'kat',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['webshop.LageKategorie'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Wein.art'
        db.add_column(u'webshop_wein', 'art',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['webshop.ArtKategorie'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting model 'ArtKategorie'
        db.delete_table(u'webshop_artkategorie')

        # Deleting model 'LageKategorie'
        db.delete_table(u'webshop_lagekategorie')

        # Adding field 'Wein.main_category'
        db.add_column(u'webshop_wein', 'main_category',
                      self.gf('mptt.fields.TreeForeignKey')(default=0, to=orm['weinkategorien.Category']),
                      keep_default=False)

        # Deleting field 'Wein.kat'
        db.delete_column(u'webshop_wein', 'kat_id')

        # Deleting field 'Wein.art'
        db.delete_column(u'webshop_wein', 'art_id')
    ...
    models = {
        ...
        u'webshop.artkategorie': {
            'Meta': {'object_name': 'ArtKategorie'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
        u'webshop.lagekategorie': {
            'Meta': {'object_name': 'LageKategorie'},
