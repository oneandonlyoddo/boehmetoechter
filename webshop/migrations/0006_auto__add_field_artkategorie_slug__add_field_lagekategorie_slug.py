...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ArtKategorie.slug'
        db.add_column(u'webshop_artkategorie', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default=0, max_length=255),
                      keep_default=False)

        # Adding field 'LageKategorie.slug'
        db.add_column(u'webshop_lagekategorie', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default=0, max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ArtKategorie.slug'
        db.delete_column(u'webshop_artkategorie', 'slug')

        # Deleting field 'LageKategorie.slug'
        db.delete_column(u'webshop_lagekategorie', 'slug')
