...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Address.user_shipping'
        db.add_column(u'myaddressmodel_address', 'user_shipping',
                      self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='shipping_address', unique=True, null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Address.user_billing'
        db.add_column(u'myaddressmodel_address', 'user_billing',
                      self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='billing_address', unique=True, null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Address.user_shipping'
        db.delete_column(u'myaddressmodel_address', 'user_shipping_id')

        # Deleting field 'Address.user_billing'
        db.delete_column(u'myaddressmodel_address', 'user_billing_id')
