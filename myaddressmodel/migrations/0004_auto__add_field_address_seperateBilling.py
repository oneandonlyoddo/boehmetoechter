...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Address.seperateBilling'
        db.add_column(u'myaddressmodel_address', 'seperateBilling',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Address.seperateBilling'
        db.delete_column(u'myaddressmodel_address', 'seperateBilling')
    ...
    models = {
        ...
        u'myaddressmodel.address': {
            ...
            'seperateBilling': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
