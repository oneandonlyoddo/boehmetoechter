...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Address.land'
        db.add_column(u'myaddressmodel_address', 'land',
                      self.gf('django.db.models.fields.CharField')(default='Deutschland', max_length=255),
                      keep_default=False)

        # Adding field 'Address.tel'
        db.add_column(u'myaddressmodel_address', 'tel',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Address.fax'
        db.add_column(u'myaddressmodel_address', 'fax',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Address.land'
        db.delete_column(u'myaddressmodel_address', 'land')

        # Deleting field 'Address.tel'
        db.delete_column(u'myaddressmodel_address', 'tel')

        # Deleting field 'Address.fax'
        db.delete_column(u'myaddressmodel_address', 'fax')
    ...
    models = {
        ...
        u'myaddressmodel.address': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'land': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
