...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'simple_events_event', 'img',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Event.location'
        db.add_column(u'simple_events_event', 'location',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'simple_events_event', 'img')

        # Deleting field 'Event.location'
        db.delete_column(u'simple_events_event', 'location')
